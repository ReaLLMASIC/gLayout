...
def add_fvf_labels(fvf_in: Component,
                pdk: MappedPDK
                ) -> Component:
    ...
    # gnd
    gnd2label = rectangle(layer=pdk.get_glayer("met2_pin"),size=(0.5,0.5),centered=True).copy()
    gnd2label.add_label(text="VBULK",layer=pdk.get_glayer("met2_label"))
    ...
    # output (3rd stage)
    outputlabel = rectangle(layer=pdk.get_glayer("met3_pin"),size=(0.5,0.5),centered=True).copy()
    ...
    # input
    inputlabel = rectangle(layer=pdk.get_glayer("met2_pin"),size=(0.5,0.5),centered=True).copy()
    inputlabel.add_label(text="VIN",layer=pdk.get_glayer("met2_label"))
