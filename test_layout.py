from src.glayout.primitives.fet import nmos
from src.glayout.pdk import sky130_mapped as sky130
import sys
import os
import subprocess
...
def check_system_tools(tool_names, miniconda3_path):
    ...
    #foss/designs/conda-env/miniconda3/envs/myenv/bin/netgen
...
def place_nfet_run_lvs():
    ...
    sky130.lvs_netgen(nmos_component, 'nmos_test',pdk_root=Path(os.getenv('PDK_ROOT')))        
